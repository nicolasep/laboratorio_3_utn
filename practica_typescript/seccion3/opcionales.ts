const opcionales = (nombre:string, apellido:string, edad?:number)=>{// se puede asiganr con el = un valor por defecto
    //con el ? dice que puede ser un parametro opcional
